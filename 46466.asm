...
UpdateBorderAnimation PROTO
DrawMenu PROTO
ShowInstructions PROTO
GameLoop PROTO
ProcessMenuState PROTO
DrawUI PROTO
UpdateHealthDisplay PROTO
DrawPlayer PROTO
UpdatePlayer PROTO
InsideLogo PROTO
ToggleMusicMute PROTO
DrawGameOver PROTO
ResetOptionColors PROTO
EnemyTurn PROTO
InitializeBorderChars PROTO
...
.data
    ...
    BORDER_CHAR_H    BYTE '-'    ; Horizontal border
    BORDER_CHAR_V    BYTE '|'    ; Vertical border
    BORDER_CHAR_C    BYTE '+'    ; Corner border
